...
class MPCCarController(CarController):
    def __init__(self, car, config):
        ...
        self.N = 5 #horizon
        self.look_ahead = 0.1
        self.v_target_multiplier = 0.6 #0.95 = safe, 1 = aggresive, >1 = spin out
    ...
    def linearizeModel(self, ref_state, curvature):
        ...
        A[i["r"]][i["ds"]] = (1 if self.simulation else 5) * dt / i_z #NOT ACCURATE TO THE MODEL, BUT IT COMMUNICATES A LINEAR RELATIONSHIP BETWEEN STEERING AND ROTATIONAL SPEED. having a little bit of this makes it work better!

        A[i["vx"]][i["dt"]] = (dt) * 6.17 * (1 if self.simulation else 8)
