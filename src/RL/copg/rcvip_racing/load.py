...
t_eps = 80
p1_state_dict = torch.load(
    './' + folder_location + experiment_name + 'model/agent1_' + str(t_eps) + '.pth')
p2_state_dict = torch.load(
    './' + folder_location + experiment_name + 'model/agent2_' + str(t_eps) + '.pth')
q_state_dict = torch.load('./' + folder_location +
                          experiment_name + 'model/val_' + str(t_eps) + '.pth')
