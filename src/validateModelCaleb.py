...
if fullsim:
    ...
    throttle = 0
    steering = 0.15
    state = (xInit, yInit, headInit, vInit, 0, 0)
    data_len = 1000
...
def step_LTVKinematic(state, control, dt=0.03):
    lf = 0.09 - 0.036
    lr = 0.036
    L = lr + lf
    m = 1.0
    ...
    # A[3][2] = 1 / L * np.tan(steer0) TODO figure out why this needs to be zero
    ...
    y = state[1]
    heading = state[3]
    v_forward = state[2]  # todo fix and reinstate
