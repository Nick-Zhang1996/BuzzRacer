...
from src.util.kalmanFilter import KalmanFilter
from math import pi, degrees, radians, sin, cos, tan, atan
from scipy.signal import savgol_filter
from src.extension import Visualization as Vis
...
def loadLog(filename=None):
    ...
    # else:
    #     filename = "/home/caleb/RC-VIP/log/steeringSysid/full_state4.p"  # sys.argv[1]
