...
car = Car.Factory(Dummy(), 'porsche', controller=None,
                  init_states=(3.7*0.6, 3.75*0.6, radians(-90), 2.0))
car.noise = False
...
DynamicBicycleCartesianSimulator.dt = 0.01
DynamicBicycleCartesianSimulator.advance_dynamics(car_state, control, car)
