...
name = 'batch_ilqgame_chasing_boost'
...
data_dict['start_lead_i_j'] = (data_dict['start_lead_i_j'] +
                               track.raceline_len_m/2) % track.raceline_len_m - track.raceline_len_m/2
data_dict['end_lead_i_j'] = (data_dict['end_lead_i_j'] + track.raceline_len_m /
                             2) % track.raceline_len_m - track.raceline_len_m/2
...
def print_table5_entry(Qop1, Qop2):
    ...
    follow_win_mask = np.logical_and(
        follow_mask, data_dict['end_lead_i_j'] > 0)
