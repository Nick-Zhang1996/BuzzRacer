...
class KinematicBicycleCurvilinearSimulator(Simulator):
    ...
    def add_car(self, car):
        ...
        if self.state_type == CurvilinearState:
            curv_state = self.main.track.cart_to_curv(car.state)
    ...
    @staticmethod
    def advance_dynamics(state: CurvilinearState, control: Control, car: Car, dt: float):
        ...
        """
        return KinematicBicycleCurvilinearSimulator.advance_dynamics(state, control, car, dt)
